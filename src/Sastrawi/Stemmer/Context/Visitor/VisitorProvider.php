...
class VisitorProvider
{
    ...
    protected function initVisitors()
    {
        ...
        $this->prefixVisitors[] = new PrefixDisambiguator(
            array(
                new Disambiguator\DisambiguatorPrefixBrury1a(),
                new Disambiguator\DisambiguatorPrefixBrury1b(),
            )
        );


        $this->prefixVisitors[] = new PrefixDisambiguator(array(new Disambiguator\DisambiguatorPrefixBrury2()));
        $this->prefixVisitors[] = new PrefixDisambiguator(array(new Disambiguator\DisambiguatorPrefixBrury3()));
        $this->prefixVisitors[] = new PrefixDisambiguator(array(new Disambiguator\DisambiguatorPrefixBrury4()));

        $this->prefixVisitors[] = new PrefixDisambiguator(
            array(
                new Disambiguator\DisambiguatorPrefixBrury5a(),
                new Disambiguator\DisambiguatorPrefixBrury5b(),
            )
        );
